...
* Студент: [Шавкат Базаров](https://up.htmlacademy.ru/htmlcss/29/user/1493583).
* Наставник: `Анна Рус`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1493583-technomart-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
